...
print('\n')
dataframe.to_csv('C:/Users/gorpa/Documents/Stocks/stocks_data.csv')
print("Finished exporting Pandas DataFrame to a CSV File")
dataframe.to_excel('C:/Users/gorpa/Documents/Stocks/stocks_data.xlsx', sheet_name=f"From {list(stock_closing_prices.keys())[0]} to {list(stock_closing_prices.keys())[6]}")
